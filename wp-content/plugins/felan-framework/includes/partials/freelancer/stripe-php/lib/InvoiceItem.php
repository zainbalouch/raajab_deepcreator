 ...
 * @property string|\MyStripe\Customer $customer The ID of the customer who will be billed when this invoice item is billed.
 ...
 * @property null|string|\MyStripe\Invoice $invoice The ID of the invoice this invoice item belongs to.
 ...
 * @property \MyStripe\StripeObject $period
 * @property null|\MyStripe\Plan $plan If the invoice item is a proration, the plan of the subscription that the proration was computed for.
 ...
 * @property null|string|\MyStripe\Subscription $subscription The subscription that this invoice item has been created for, if any.
 * @property string $subscription_item The subscription item that this invoice item has been created for, if any.
 * @property null|\MyStripe\TaxRate[] $tax_rates The tax rates which apply to the invoice item. When set, the <code>default_tax_rates</code> on the invoice do not apply to this invoice item.
