 ...
 * @property \MyStripe\StripeObject[] $tax_amounts The amount of tax calculated per tax rate for this line item
 * @property \MyStripe\TaxRate[] $tax_rates The tax rates which apply to the line item.
