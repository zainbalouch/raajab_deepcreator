 ...
 * @property null|\MyStripe\StripeObject $address The customer's address.
 ...
 * @property null|\MyStripe\Discount $discount Describes the current discount active on the customer, if there is one.
 ...
 * @property \MyStripe\StripeObject $invoice_settings
 ...
 * @property null|\MyStripe\StripeObject $shipping Mailing and shipping address for the customer. Appears on invoices emailed to this customer.
 * @property \MyStripe\Collection $sources The customer's payment sources, if any.
 * @property \MyStripe\Collection $subscriptions The customer's current subscriptions, if any.
 ...
 * @property \MyStripe\Collection $tax_ids The customer's tax IDs.
 */
class Customer extends ApiResource
{
     ...
     *
     * @return \MyStripe\Customer the updated customer
     */
     ...
     *
     * @return \MyStripe\Collection the list of customer balance transactions
     */
     ...
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\CustomerBalanceTransaction
     */
     ...
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\Collection the list of payment sources (AlipayAccount, BankAccount, BitcoinReceiver, Card or Source)
     */
     ...
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\AlipayAccount|\MyStripe\BankAccount|\MyStripe\BitcoinReceiver|\MyStripe\Card|\MyStripe\Source
     */
     ...
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\Collection the list of tax ids
     */
