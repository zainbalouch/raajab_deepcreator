 ...
 * @property null|\MyStripe\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\MyStripe\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \MyStripe\StripeObject $default_settings
 ...
 * @property \MyStripe\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|\MyStripe\StripeObject $renewal_interval This field has been deprecated. Interval and duration at which the subscription schedule renews for when it ends if <code>renewal_behavior</code> is <code>renew</code>.
 ...
 * @property null|string|\MyStripe\Subscription $subscription ID of the subscription managed by the subscription schedule.
 */
