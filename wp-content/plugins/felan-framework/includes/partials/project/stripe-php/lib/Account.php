 ...
 * @property null|\MyStripe\StripeObject $business_profile Business information about the account.
 * @property null|string $business_type The business type.
 * @property \MyStripe\StripeObject $capabilities
 * @property bool $charges_enabled Whether the account can create live charges.
 * @property \MyStripe\StripeObject $company
 ...
 * @property \MyStripe\Collection $external_accounts External accounts (bank accounts and debit cards) currently attached to this account
 * @property \MyStripe\Person $individual <p>This is an object representing a person associated with a Stripe account.</p><p>Related guide: <a href="https://stripe.com/docs/connect/identity-verification-api#person-information">Handling Identity Verification with the API</a>.</p>
 ...
 * @property null|\MyStripe\StripeObject $settings Options for customizing how the account functions within Stripe.
 * @property \MyStripe\StripeObject $tos_acceptance
...
class Account extends ApiResource
{
     ...
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\StripeObject object containing the response from the API
     */
     ...
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\Collection the list of persons
     */
     ...
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\Collection the list of capabilities
     */
     ...
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\Collection the list of external accounts (BankAccount or Card)
     */
     ...
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\BankAccount|\MyStripe\Card
     */
