 ...
 * @property \MyStripe\StripeObject $error
 * @property null|\MyStripe\File $file The file object representing the results of the query.
 ...
 */
class ScheduledQueryRun extends \MyStripe\ApiResource
{
