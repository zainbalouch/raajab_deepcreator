 ...
 * @property null|string|\MyStripe\Charge $charge ID of the latest charge generated for this invoice, if any.
 ...
 * @property null|\MyStripe\StripeObject[] $custom_fields Custom fields displayed on the invoice.
 * @property string|\MyStripe\Customer $customer The ID of the customer who will be billed.
 * @property null|\MyStripe\StripeObject $customer_address The customer's address. Until the invoice is finalized, this field will equal <code>customer.address</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\MyStripe\StripeObject $customer_shipping The customer's shipping information. Until the invoice is finalized, this field will equal <code>customer.shipping</code>. Once the invoice is finalized, this field will no longer be updated.
 ...
 * @property null|\MyStripe\StripeObject[] $customer_tax_ids The customer's tax IDs. Until the invoice is finalized, this field will contain the same tax IDs as <code>customer.tax_ids</code>. Once the invoice is finalized, this field will no longer be updated.
 * @property null|string|\MyStripe\PaymentMethod $default_payment_method ID of the default payment method for the invoice. It must belong to the customer associated with the invoice. If not set, defaults to the subscription's default payment method, if any, or to the default payment method in the customer's invoice settings.
 * @property null|string|\MyStripe\StripeObject $default_source ID of the default payment source for the invoice. It must belong to the customer associated with the invoice and be in a chargeable state. If not set, defaults to the subscription's default source, if any, or to the customer's default source.
 * @property null|\MyStripe\TaxRate[] $default_tax_rates The tax rates applied to this invoice, if any.
 ...
 * @property null|\MyStripe\Discount $discount Describes the current discount applied to this invoice, if there is one.
 ...
 * @property \MyStripe\Collection $lines The individual line items that make up the invoice. <code>lines</code> is sorted as follows: invoice items in reverse chronological order, followed by the subscription, if any.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\MyStripe\StripeObject $metadata Set of key-value pairs that you can attach to an object. This can be useful for storing additional information about the object in a structured format.
 ...
 * @property null|string|\MyStripe\PaymentIntent $payment_intent The PaymentIntent associated with this invoice. The PaymentIntent is generated when the invoice is finalized, and can then be used to pay the invoice. Note that voiding an invoice will cancel the PaymentIntent.
 ...
 * @property \MyStripe\StripeObject $status_transitions
 * @property null|string|\MyStripe\Subscription $subscription The subscription that this invoice was prepared for, if any.
 ...
 * @property \MyStripe\StripeObject $threshold_reason
 * @property int $total Total after discounts and taxes.
 * @property null|\MyStripe\StripeObject[] $total_tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class Invoice extends ApiResource
{
     ...
     *
     * @return \MyStripe\Invoice the upcoming invoice
     */
     ...
     *
     * @return \MyStripe\Collection the list of lines (InvoiceLineItem)
     */
