 ...
 * @property \MyStripe\StripeObject $ach_credit_transfer
 * @property \MyStripe\StripeObject $ach_debit
 * @property \MyStripe\StripeObject $acss_debit
 * @property \MyStripe\StripeObject $alipay
 ...
 * @property \MyStripe\StripeObject $au_becs_debit
 * @property \MyStripe\StripeObject $bancontact
 * @property \MyStripe\StripeObject $card
 * @property \MyStripe\StripeObject $card_present
 * @property string $client_secret The client secret of the source. Used for client-side retrieval using a publishable key.
 * @property \MyStripe\StripeObject $code_verification
 ...
 * @property \MyStripe\StripeObject $eps
 ...
 * @property \MyStripe\StripeObject $giropay
 * @property \MyStripe\StripeObject $ideal
 * @property \MyStripe\StripeObject $klarna
 ...
 * @property \MyStripe\StripeObject $multibanco
 * @property null|\MyStripe\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property \MyStripe\StripeObject $p24
 * @property \MyStripe\StripeObject $receiver
 * @property \MyStripe\StripeObject $redirect
 * @property \MyStripe\StripeObject $sepa_credit_transfer
 * @property \MyStripe\StripeObject $sepa_debit
 * @property \MyStripe\StripeObject $sofort
 * @property \MyStripe\StripeObject $source_order
 ...
 * @property \MyStripe\StripeObject $three_d_secure
 ...
 * @property \MyStripe\StripeObject $wechat
 */
class Source extends ApiResource
{
     ...
     *
     * @throws \MyStripe\Exception\UnexpectedValueException if the source is not attached to a customer
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\Source the detached source
     */
     ...
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\Collection the list of source transactions
     */
