 ...
 * @property \MyStripe\StripeObject $parameters
 ...
 * @property null|\MyStripe\File $result The file object representing the result of the report run (populated when <code>status=succeeded</code>).
 ...
 */
class ReportRun extends \MyStripe\ApiResource
{
