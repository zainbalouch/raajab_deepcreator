...
abstract class ApiErrorException extends \Exception implements ExceptionInterface
{
     ...
     * @param null|array|\MyStripe\Util\CaseInsensitiveArray $httpHeaders the HTTP headers array
     ...
     *
     * @return null|\MyStripe\ErrorObject
     */
     ...
     *
     * @param null|\MyStripe\ErrorObject $error
     */
     ...
     *
     * @return null|array|\MyStripe\Util\CaseInsensitiveArray
     */
     ...
     *
     * @param null|array|\MyStripe\Util\CaseInsensitiveArray $httpHeaders
     */
     ...
     *
     * Cf. the `CODE_*` constants on {@see \MyStripe\ErrorObject} for possible
     * values.
     *
     * @return null|string
     */
    ...
    protected function constructErrorObject()
    {
        ...
        return \MyStripe\ErrorObject::constructFrom($this->jsonBody['error']);
    }
}
