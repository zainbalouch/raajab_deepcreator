 ...
 * @property \MyStripe\StripeObject $customer_acceptance
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property \MyStripe\StripeObject $multi_use
 * @property string|\MyStripe\PaymentMethod $payment_method ID of the payment method associated with this mandate.
 * @property \MyStripe\StripeObject $payment_method_details
 * @property \MyStripe\StripeObject $single_use
