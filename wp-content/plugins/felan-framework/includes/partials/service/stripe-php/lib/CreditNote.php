 ...
 * @property null|string|\MyStripe\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property string|\MyStripe\Invoice $invoice ID of the invoice.
 * @property \MyStripe\Collection $lines Line items that make up the credit note
 ...
 * @property null|string|\MyStripe\Refund $refund Refund related to this credit note.
 ...
 * @property \MyStripe\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource
{
     ...
     *
     * @return \MyStripe\CreditNote the previewed credit note
     */
     ...
     * @throws \MyStripe\Exception\ApiErrorException if the request fails
     *
     * @return \MyStripe\Collection the list of credit note line items
     */
