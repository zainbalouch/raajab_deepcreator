 ...
 * @property null|\MyStripe\StripeObject[] $display_items The line items, plans, or SKUs purchased by the customer.
 ...
 * @property null|string|\MyStripe\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 ...
 * @property null|string|\MyStripe\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\MyStripe\StripeObject $shipping Shipping information for this Checkout Session.
 * @property null|\MyStripe\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 ...
 * @property null|string|\MyStripe\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 */
class Session extends \MyStripe\ApiResource
{
