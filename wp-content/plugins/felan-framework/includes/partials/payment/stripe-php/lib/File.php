 ...
 * @property null|\MyStripe\Collection $links A list of <a href="https://stripe.com/docs/api#file_links">file links</a> that point at this file.
...
class File extends ApiResource
{
     ...
     *
     * @return \MyStripe\File the created file
     */
    public static function create($params = null, $opts = null)
    {
        $opts = \MyStripe\Util\RequestOptions::parse($opts);
        if (null === $opts->apiBase) {
            $opts->apiBase = Stripe::$apiUploadBase;
        }
        // Manually flatten params, otherwise curl's multipart encoder will
        // choke on nested arrays.
        $flatParams = \array_column(\MyStripe\Util\Util::flattenParams($params), 1, 0);
