 ...
 * @property null|string|\MyStripe\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\MyStripe\Customer $customer The ID of the customer that the bank account is associated with.
