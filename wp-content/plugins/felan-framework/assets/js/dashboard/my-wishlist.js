(function ($) {
    ...
    var my_wishlist = $(".felan-my-wishlist");

    var ajax_url = felan_my_wishlist_vars.ajax_url,
        not_jobs = felan_my_wishlist_vars.not_jobs;
    ...
    $(document).ready(function () {
        ...
        my_wishlist.find("select.search-control").on("change", function () {
            my_wishlist.find(".felan-pagination").find('input[name="paged"]').val(1);
            ajax_load_wishlist();
        });
        ...
        $("body").on(
            "click",
            ".felan-my-wishlist .jobs-control .btn-delete",
            function (e) {
                e.preventDefault();
        ...
        $("body").on(
            "click",
            ".felan-my-wishlist .felan-pagination a.page-numbers",
            function (e) {
                e.preventDefault();
                my_wishlist
        ...
        function ajax_load_wishlist(item_id = "", action_click = "") {
            ...
            paged = my_wishlist.find('.felan-pagination input[name="paged"]').val();

            $.ajax({
                dataType: "json",
                url: ajax_url,
                data: {
                    action: "felan_filter_my_wishlist",
