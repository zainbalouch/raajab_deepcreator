    ...
    <div class="tab-single-content">
        <div id="tab-basic" class="tab-single-info">
            <div class="package-top">
                ...
                <p class="des"><?php echo esc_html($service_basic_des); ?></p>
            </div>
        ...
        <div id="tab-standard" class="tab-single-info">
            <div class="package-top">
                ...
                <p class="des"><?php echo esc_html($service_standard_des); ?></p>
            </div>
            <div class="package-center">
                <ul class="content">
                    <li>
        ...
        <div id="tab-premium" class="tab-single-info">
            <div class="package-top">
                ...
                <p class="des"><?php echo esc_html($service_premium_des); ?></p>
            </div>
            <div class="package-center">
                <ul class="content">
                    <li>
