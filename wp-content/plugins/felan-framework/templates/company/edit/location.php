...
$company_location = get_post_meta($company_data->ID, FELAN_METABOX_PREFIX . 'company_location', true);
        ...
        <div class="form-group col-md-6">
            ...
            <div class="select2-field">
                <select name="company_location" class="felan-select2">
                    <?php felan_get_taxonomy_location('company-location', 'company-state', 'company-location-state', 'company-state-country', $company_data->ID); ?>
                </select>
            </div>
        </div>
