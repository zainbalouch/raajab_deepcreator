...
$jobs_select_apply = isset($jobs_meta_data[FELAN_METABOX_PREFIX . 'jobs_select_apply']) ? $jobs_meta_data[FELAN_METABOX_PREFIX . 'jobs_select_apply'][0] : '';
$jobs_apply_email = isset($jobs_meta_data[FELAN_METABOX_PREFIX . 'jobs_apply_email']) ? $jobs_meta_data[FELAN_METABOX_PREFIX . 'jobs_apply_email'][0] : '';
$jobs_apply_external = isset($jobs_meta_data[FELAN_METABOX_PREFIX . 'jobs_apply_external']) ? $jobs_meta_data[FELAN_METABOX_PREFIX . 'jobs_apply_external'][0] : '';
$jobs_apply_call_to = isset($jobs_meta_data[FELAN_METABOX_PREFIX . 'jobs_apply_call_to']) ? $jobs_meta_data[FELAN_METABOX_PREFIX . 'jobs_apply_call_to'][0] : '';
...
<div class="row">
    ...
    <?php if (!in_array('fields_jobs_apply_email', $hide_jobs_apply)) : ?>
        <div class="felan-section-apply-select form-group col-md-6" id="email">
            ...
            <input type="email" id="jobs_apply_email" name="jobs_apply_email" value="<?php echo esc_attr($jobs_apply_email) ?>" placeholder="<?php esc_attr_e('Enter email', 'felan-framework') ?>">
        </div>
    <?php endif; ?>
    ...
    <?php if (!in_array('fields_jobs_apply_external', $hide_jobs_apply)) : ?>
        <div class="felan-section-apply-select form-group col-md-6" id="external">
            ...
            <input type="url" id="jobs_apply_external" name="jobs_apply_external" value="<?php echo esc_attr($jobs_apply_external) ?>" placeholder="<?php esc_attr_e('Enter url', 'felan-framework') ?>">
        </div>
    <?php endif; ?>
    ...
    <?php if (!in_array('fields_jobs_call_to_apply', $hide_jobs_apply)) : ?>
        <div class="felan-section-apply-select form-group col-md-6" id="call-to">
            ...
            <div class="tel-group">
                ...
                <input type="tel" id="jobs_apply_call_to" name="jobs_apply_call_to" value="<?php echo esc_attr($jobs_apply_call_to) ?>" placeholder="<?php esc_attr_e('Enter phone', 'felan-framework') ?>">
            </div>
        </div>
    <?php endif; ?>
