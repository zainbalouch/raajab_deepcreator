...
$author_employer_id = get_post_field('post_author', $disputes_id);
$employer_avatar = get_the_author_meta('author_avatar_image_url', $author_employer_id);
$employer_name = get_the_author_meta('display_name', $author_employer_id);

//Message
$user_name = $current_user->display_name;
$sender_id = get_current_user_id();
$sender_messages = get_user_meta($sender_id, FELAN_PLUGIN_PREFIX . 'disputes_messages_freelancer_' . $disputes_id, true);
$receive_messages = get_user_meta($author_employer_id, FELAN_PLUGIN_PREFIX . 'disputes_messages_employer_' . $disputes_id, true);
$all_messages = [];
            ...
            <div class="order-sidebar custom-scrollbar">
                     ...
                     <div class="history-item <?php echo esc_attr($is_sender ? 'sender' : 'receiver'); ?>">
                         <div class="info-history">
                             ...
                             <div class="info">
                                 ...
                                 <?php echo esc_html( $is_sender ? __( 'Freelancer', 'felan-framework' ) : __( 'Employer', 'felan-framework' ) ); ?>
                             </div>
                         </div>
                ...
                <?php if ($status == 'open') : ?>
                    <form class="reply" id="felan-disputes-message">
                        ...
                        <input type="hidden" name="recipient_id" id="recipient_id" value="<?php echo esc_attr($author_employer_id); ?>">
